...
public class ItemBuilder {
     ...
     * Use ItemMeta.addEnchant() on item
     * <p>
     * <b>NOTE: This method is in beta and may not work as expected.
     * It is also not tested yet.</b>
     * </p>
     *
     * @return ItemBuilder object
     * @author Erik Pförtner
    ...
    public ItemBuilder setEnchanted() {
        ItemMeta meta = this.item.getItemMeta();
        assert meta != null;
        meta.addEnchant(new UnknownEnchantment(), 1, true);
    ...
    /**
     * New Enchantment class to be used as an invisible enchantment
     * <p>
     * This class is used to add an invisible enchantment to an item
     * to be able to detect it later on.
     * This class is not meant to be used as a real enchantment.
     * </p>
     *
     * @author Erik Pförtner
     * @see Enchantment
    ...
    public static class UnknownEnchantment extends Enchantment {
        ...
        public @NotNull Component displayName(int i) {
            return Component.text("UnknownEnchantment");
        }
        ...
        @Override
        public int getMinModifiedCost(final int i) {
            return 0;
        }

        @Override
        public int getMaxModifiedCost(final int i) {
            return 0;
        }
        ...
        @Override
        public float getDamageIncrease(final int i, @NotNull EntityCategory entityCategory) {
            return 0;
        }
        ...
        public NamespacedKey getKey() {
            return new NamespacedKey("district", "unknown_enchantment");
        }
